...
function bellman_operator!(p::BasicRBC,
    ...
    n = length(k_grid)
    m = length(z)
    f=Array{Tuple{Float64,Float64,Int64,Int64}}(n,1)
...
function main()
        ...
        while error > tol
            E = f_value*T';
            func = bellman_operator!(p ,Matrix(output),Matrix(f_value),Matrix(f_valueN),Matrix(f_policy),Matrix(E))
            (x,y)=size(func)  
            #.............................................................
            for kk=1 : x*y
                (j,i) = ind2sub(func,kk)
                (f_valueN[j,i],f_policy[j,i]) = func[kk]
            end
            #.............................................................
